...
public class CobrancaGeradaAsaasData implements Serializable {
    ...
    private CobrancaGeradaCreditCardAsaas creditCard;
    ...
    private CobrancaGeradaDiscontoAsaas discount;
    private CobrancaGeradaFineAsaas fine;
    private CobrancaGeradaInterestAsaas interest;
    private List<CobrancaGeradaSplitAsaas> split = new ArrayList<CobrancaGeradaSplitAsaas>();
    private Boolean postalService;
    private Integer daysAfterDueDateToRegistrationCancellation;
    private CobrancaGeradaChargeBackAsaas chargeback;
    private CobrancaGeradaEscrowAsaas escrow;
    private List<AsaasRefundDTO> refunds;
    ...
    public CobrancaGeradaCreditCardAsaas getCreditCard() {
        return creditCard;
    }

    public void setCreditCard(CobrancaGeradaCreditCardAsaas creditCard) {
    ...
    public CobrancaGeradaDiscontoAsaas getDiscount() {
        return discount;
    }

    public void setDiscount(CobrancaGeradaDiscontoAsaas discount) {
        this.discount = discount;
    }

    public CobrancaGeradaFineAsaas getFine() {
        return fine;
    }

    public void setFine(CobrancaGeradaFineAsaas fine) {
        this.fine = fine;
    }

    public CobrancaGeradaInterestAsaas getInterest() {
        return interest;
    }

    public void setInterest(CobrancaGeradaInterestAsaas interest) {
        this.interest = interest;
    }

    public List<CobrancaGeradaSplitAsaas> getSplit() {
        return split;
    }

    public void setSplit(List<CobrancaGeradaSplitAsaas> split) {
        this.split = split;
    }
    ...
    public CobrancaGeradaChargeBackAsaas getChargeback() {
        return chargeback;
    }

    public void setChargeback(CobrancaGeradaChargeBackAsaas chargeback) {
        this.chargeback = chargeback;
    }

    public CobrancaGeradaEscrowAsaas getEscrow() {
        return escrow;
    }

    public void setEscrow(CobrancaGeradaEscrowAsaas escrow) {
        this.escrow = escrow;
    }

    public List<AsaasRefundDTO> getRefunds() {
        return refunds;
    }

    public void setRefunds(List<AsaasRefundDTO> refunds) {
